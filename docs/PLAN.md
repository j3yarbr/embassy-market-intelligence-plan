...
**Status:** 🟢 v1 live · **Last updated:** 2026-09-09
...
2. **Month-to-Month Revenue chart** — single-hue bar chart, hover tooltips, plus a collapsible "Monthly figures" table with a YoY column and a click-to-expand detail view per month: companies this month vs. the same month last year, top-5 sellers each year, a win-back list (real prior-year buyers with zero revenue this month, ranked by dollar size), and an "Export one-pager" button that opens a print-ready report for that month in a new tab (added 2026-09-09 — see its own section below).
